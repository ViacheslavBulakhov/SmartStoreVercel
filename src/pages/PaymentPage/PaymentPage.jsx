    ...
    <MethodList>
      <MethodItem>
        ...
        <div>
          ...
          <p>
            Якщо у вас є банківська картка, ви зможете безпечно оплатити покупку
            за її допомогою. Оплата замовлення здійснюється через платіжну
            систему картками VISA та MasterCard будь-якого українського банку.
          </p>
        </div>
      </MethodItem>
      <MethodItem>
        ...
        <div>
          ...
          <p>
            ...
            товару у відділенні Нової Пошти. Ви зможете оплатити замовлення без
            додаткових комісій безпосередньо при його отриманні.
          </p>
        </div>
      </MethodItem>
      <MethodItem>
